...
public class TC_002_HypoThyroidism extends BaseClass {
...

	{
		...
		xlutil.setCellData("HYPOTHYROIDISM", 0, 2, "RecipeCategory");
		xlutil.setCellData("HYPOTHYROIDISM", 0, 3, "FoodCategory");
		xlutil.setCellData("HYPOTHYROIDISM", 0, 4, "Preparation Time");
		xlutil.setCellData("HYPOTHYROIDISM", 0, 5, "Cooking Time");
		xlutil.setCellData("HYPOTHYROIDISM", 0, 6, "Ingredients");
		xlutil.setCellData("HYPOTHYROIDISM", 0, 7, "RecipeMethod");
							...
							if(recipeLinksSize>0) {
								...
								{         
									...
									if(flag==0)
									{
										...
										System.out.println("------------------------");
										targetmorbidity=SetHypoThyroidismMorbidity().toString();
